...
class ConfiguratorServices
  def self.SaveConfiguration
    ...
    new_dhcp_config << "shared-network registry {\n\n"
      ...
      Rails.logger.debug("Generate dunny configuration reuired by failover configuration")
      new_dhcp_config << "subnet 172.31.254.0 netmask 255.255.255.0 {\n"
      new_dhcp_config << "  option routers 172.31.254.1;\n"
      new_dhcp_config << "  option subnet-mask 255.255.255.0;\n"
      new_dhcp_config << "  option domain-name \"dummy-nome.tld\";\n"
      new_dhcp_config << "  default-lease-time 43200;\n"
      new_dhcp_config << "  max-lease-time 86400;\n"
      new_dhcp_config << "  pool {\n"
      new_dhcp_config << "    failover peer \"failover-partner\";\n"
      new_dhcp_config << "    range 172.31.254.253 172.31.254.254;\n"
      new_dhcp_config << "  }\n"
      new_dhcp_config << "}\n\n"
    ...
    dhcp_networks.each do |n|
      ...
      if !n.ntp_servers.nil?
        new_dhcp_config << "  option ntp-servers " + n.ntp_servers + ";\n"
      end
