...
class ConfiguratorServices
  ...
  # def self.named_checkzone(soa_zone)
  #   @HOST = soa_zone.domain.customer.ip_primary_dns
  #   @USER = soa_zone.domain.customer.service_dns_username
  #   @PASS = soa_zone.domain.customer.service_dns_password
  #   
  #   file_prefix = soa_zone.domain.customer.prefix_dns_files
  #   
  #   check_named_checkzone_script = "/home/named/tools/named-checkzone.sh"
  #   
  #   # @gen_zona = Zone.rr_order.find_all_by_domain_id(soa_zone.domain_id)    
  #   
  #   # upload a soa file to a remote dns server
  #   remote_soa_path = "/home/named/#{file_prefix}_zones/#{soa_zone.domain.dominio}.host"
  #   
  #   
  #   Rails.logger.debug("named_checkzone DOMINIO: #{soa_zone.domain.dominio} su nameserver #{@HOST}!")
  #   
  #   exit_code = 0
  #   output_result = nil
  #   
  #   # if Rails.env.production? && !@HOST.blank?
  #   if !@HOST.blank?  
  #     begin
  #       Net::SSH.start( @HOST, @USER, :password => @PASS, :timeout => 30  ) do |ssh|
  #         Rails.logger.info("Connected to host: #{@HOST}")    
  #       
  #         output_result = ssh.exec!("#{check_named_checkzone_script} #{file_prefix} #{soa_zone.domain.dominio}")
  #         Rails.logger.info("Done!")
  #       end
  #       rescue Timeout::Error => e
  #         exit_code = 1
  ...
  #         exit_code = 1
  #         Rails.logger.info("Host unreachable")
  #         raise e
  #       rescue Errno::ECONNREFUSED => e
  #         exit_code = 1
  #         Rails.logger.info("Connection refused")
  #         raise e
  ...
  #         exit_code = 1
  #         Rails.logger.info("SOCKET ERROR")
  #         raise e
  #       rescue Exception => e
  #         exit_code = 1
  #         Rails.logger.info("EXCEPTION")
  ...
  #     Rails.logger.debug("Esito del comando: #{exit_code}")
  #     #Rails.logger.debug("#===========================")
  #     #Rails.logger.debug("#{output_result}")
  #     #Rails.logger.debug("#===========================")
  #   end
  #   
  #   if exit_code != 0
